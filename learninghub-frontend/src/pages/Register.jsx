    ...
    <div className="relative min-h-screen flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-dark-300 mt-2 text-sm">Sign up to access your courses</p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" value={form.username} onChange={(e) => update('username', e.target.value)}
                  placeholder="johndoe" className="input-glass pl-10" required />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={form.email} onChange={(e) => update('email', e.target.value)}
                  placeholder="john@example.com" className="input-glass pl-10" required />
              </div>
            </div>
